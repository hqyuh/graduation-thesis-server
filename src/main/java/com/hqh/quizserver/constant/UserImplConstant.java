...
public class UserImplConstant {
    ...
    public static final String ACCOUNT_UNLOCK_SUCCESSFUL = "Account unlock successful";
    public static final String ACCOUNT_LOCK_SUCCESSFUL = "Account lock successful";
